...
// MQTT settings
const char* mqtt_broker = "<your-mqtt-broker-ip-or-hostname>";
...
// Times for desk movement (11 seconds)
const int TIME_LOWERING_DESK = 11000;
const int TIME_RAISING_DESK = 11000; 
